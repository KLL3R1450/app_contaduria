...
public class DeclaracionDAO {
    ...
    public String colocarGastos(int id_declaracion) {
        ...
        try (Connection conexion = ConectorBD.getConexion();
             PreparedStatement gastos = conexion.prepareStatement(sql)) {
    ...
    public String colocarIngresos(int id_declaracion) {
        ...
        try (Connection conexion = ConectorBD.getConexion();
             PreparedStatement ingresos = conexion.prepareStatement(sql)) {
    ...
    /**
     * Funcion que remueve el estado de declarado
     * @param id_declaracion Variable de tipo int que contiene el id de la declaracion a modificar
     * @return "correcto" o mensaje de error
     */
